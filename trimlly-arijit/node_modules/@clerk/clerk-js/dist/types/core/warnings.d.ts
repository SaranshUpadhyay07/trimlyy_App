declare const warnings: {
    ...
    cannotRenderAnyOrganizationComponent: (componentName: "OrganizationProfile" | "OrganizationSwitcher" | "OrganizationList" | "CreateOrganization") => string;
    cannotRenderAnyCommerceComponent: (componentName: "PricingTable" | "Checkout" | "PlanDetails") => string;
